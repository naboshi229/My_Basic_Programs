...
- print at the end shows user using ASCII images (from Hangman_Art.py file) that are stored in stages list which shows appropiate picture to the value of lives.
